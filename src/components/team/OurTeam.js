...
export const OurTeam = () => {
  ...
  const teamMembers = peopleData.map((person) => <TeamMember person={person} />);
    ...
    <div className="our-team">
      <div className="our-team__header-container">
        ...
        <p className="header-description">
          We are excellent experts. We are excellent experts. We are excellent experts.
        </p>
      </div>
      <div className="our-team__members-container">{teamMembers}</div>
    </div>
  );
};
