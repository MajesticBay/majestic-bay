            ...
            <div className="our-team__members-container">
                {/* <div className="member">
                    ...
                    <About about={about} onMouseEnter={() => setAbout(!about)}>
                        <span className="green">From Mike:</span>
                        {"\u00A0"}For more than 7 years I have been helping brands develop
                        their business through design.{"\u00A0"}
                        <span className="italic">
                            Visual support of the brand — my task.
                        </span>
                        {"\u00A0"}I like to work on projects from the start and use all my
                        experience to do the job perfectly.
                    </About>
                    <QuoteAbout about={about} onMouseLeave={() => setAbout(!about)}>
                        Mike — is the best designer on both sides of the ocean (smiley face)
                    </QuoteAbout>
                    <a className="member__contact" href="http://localhost:3000/">
                        contact Mike
                    </a>
                </div>
                <div className="member">
                    <div className="member__top">
                        ...
                        <p className="member__title">
                            Front / End / Back & React Native Developer
                        </p>
                    </div>
                ...
                <TeamMember name="Heorhii"  />
                <TeamMember name="Liliya"  />
            </div>
        </div>
    );
};
