    ...
    <div className="our-team">
        ...
        <div className="our-team__members-container">
            <div className="member">
                ...
                <p><span>From Mike:</span>For more than 7 years I have been helping brands develop their business through design. Visual support of the brand — my task. I like to work on projects from the start and use all my experience to do the job perfectly. </p>
