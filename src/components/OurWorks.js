  ...
  <div className="our-works">
    ...
    <div className="project">
      ...
      <p className="project__description">
        Application, wich designed for people with spinal cord injuries, hernia
        or other problems that limit physical activity.
      </p>
    </div>
    <div className="project">
      ...
      <p className="project__description">
        Web site and identity for the most enjoyable private café in the Seattle
        Industrial Zone.
      </p>
    </div>
    <div className="project">
      ...
      <p className="project__description">
        Web site for company that develops and implements robotics process
        automatization based solutions.
      </p>
    </div>
    <div className="project">
      ...
      <p className="project__description">
        Corporate identity and website for IT company developing a complex and
        highly loaded backend for government systems.
      </p>
    </div>
    <div className="project">
    ...
    <div className="project">
      ...
      <p className="project__description">
        Corporate style and template of an online store for a construction
        company or a spare parts store.
      </p>
    </div>
  </div>
);
